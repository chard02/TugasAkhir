            ...
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="base">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="{{route ('admin.researchers.index')}}">
                        <span class="sub-item">Researchers</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route ('admin.researchers.requests')}}">
                        <span class="sub-item">Request</span>
                      </a>
                    </li>
                    <li>
                      <a href="{{route ('admin.researchers.create')}}">
                        <span class="sub-item">Create Researchers</span>
                      </a>
                    </li>
                  </ul>
                </div>
                  ...
                  <li>
                    ...
                    <li>
                      <a href="charts/sparkline.html">
                        <span class="sub-item">Edit News</span>
                      </a>
                    </li>
                  </ul>
                </div>
